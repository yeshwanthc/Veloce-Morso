  ...
  return (
    <header className="text-black p-4 w-full flex justify-between items-center bg-[#f1f1f1]">
      <Link href="/">
          ...
          <img src="/images/VeloceMorso.png" alt="Logo" className="h-[70px] object-cover"/>
      ...
      <nav className="flex gap-x-8 font-semibold items-center">
        ...
        <Link className="bg-red1 py-2 px-3 text-white rounded-[4px] hover:bg-red-600" href="/login">Login</Link>
